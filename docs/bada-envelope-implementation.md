...
The exact CSV, event, and metadata interface is defined in
[`recorder-v11-contract.md`](recorder-v11-contract.md).
...
output described by [`reproducibility-matrix.md`](reproducibility-matrix.md).

Generic non-clean configuration management, phase-aware speed limits, and
other unresolved modelling questions are tracked in
